        ...
        <TableBody>
          {rows.map((row) => (
              ...
              >
                ...
                <TableCell align="right" value={sentiment}>{row.sentimentScore}</TableCell>
                <TableCell align="right" value={reviews}>{row.reviews}</TableCell>
                <TableCell align="right" value={lastexemple}>{row.lastExample}</TableCell>
