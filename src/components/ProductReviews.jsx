    ...
    >
      ...
      >
        <Box style={{ display: "flex",flexDirection:"column", padding: "0 1rem" }}>
          ...
          <Typography variant='h6' component='div' style={{fontSize:".8rem"}}>
            PRODUCT SCORE: 3.5
          </Typography>
        </Box>
        <Box>
          ...
          <Typography variant="body2" component="div" color="gray" gutterBottom style={{margin:"1rem auto"}}>
           Sentiment Analysis:
          </Typography>
          <Box
            style={{
          ...
          >
            ...
            >
              <SentimentSatisfiedTwoToneIcon style={{ color: "rgb(70,128,131)" }} />
              <Box
                style={{
                  marginLeft: ".3rem",
                  height: "15px",
